...
<div class="product__page__content container">
  <div class="board-layout">
    ...
    <div class="board-content">
      ...
      <form method="post" action="/helpdesk/update_ok">
        <!-- PK -->
        ...
        <div class="form-section">
          ...
          <table class="form-table">
                ...
                <select name="hcate1" required>
                  <c:forEach var="c" items="${cate1List}">
                    <option value="${c.cateNo}"
                      <c:if test="${c.cateNo == vo.hcate1}">selected</c:if>>
                      ${c.cateName}
                    </option>
                  </c:forEach>
                </select>
              ...
              <td>
                <select name="hcate2" required>
                  <c:forEach var="c" items="${cate2List}">
                    <option value="${c.cateNo}"
                      <c:if test="${c.cateNo == vo.hcate2}">selected</c:if>>
                      ${c.cateName}
                    </option>
                  </c:forEach>
                </select>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="hsubject" value="${vo.hsubject}" required>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <textarea name="hcontent" required>${vo.hcontent}</textarea>
              </td>
            </tr>
        ...
        <div class="form-footer">
          <button type="button" class="cancel"
                  onclick="location.href='/helpdesk/detail?hno=${vo.hno}'">
            취소
          </button>
