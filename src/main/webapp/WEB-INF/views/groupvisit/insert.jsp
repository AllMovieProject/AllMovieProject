...
<div class="product__page__content container">
  <div class="board-layout">
    ...
    <div class="board-content">
      ...
      <form method="post" action="/groupvisit/insert_ok">
        ...
        <div class="form-section">
          ...
          <table class="form-table">
            ...
            <tr>
              ...
              <td>
                <input type="text" name="gsubject" maxlength="50" required>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <textarea name="gcontent" maxlength="2000" required></textarea>
              </td>
            </tr>
          </table>
        </div>
