...
<div class="product__page__content container">
  <div class="board-layout">
    ...
    <div class="board-content">
      ...
      <form method="post" action="/groupvisit/update_ok">
        <!-- PK -->
        ...
        <div class="form-section">
          ...
          <table class="form-table">
                ...
                <select name="gtype" required>
                  <c:forEach var="c" items="${cate1List}">
                    <option value="${c.cateNo}"
                      <c:if test="${c.cateNo == vo.gtype}">selected</c:if>>
                      ${c.cateName}
                    </option>
                  </c:forEach>
                </select>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="gsubject" value="${vo.gsubject}" required>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <textarea name="gcontent" required>${vo.gcontent}</textarea>
              </td>
            </tr>
        ...
        <div class="form-footer">
          <button type="button" class="cancel"
                  onclick="location.href='/groupvisit/detail?gno=${vo.gno}'">
            취소
          </button>
